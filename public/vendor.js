...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(m, module) {"use strict";
	...
	})(typeof window !== "undefined" ? window : undefined, function factory(global, undefined) {
		// eslint-disable-line
		"use strict";
	   ...
	   */
		...
		function setSingleAttr(node, attrName, dataAttr, cachedAttr, tag, namespace) {
			if (attrName === "config" || attrName === "key") {
				...
				try {
					if (tag !== "input" && !node.isContentEditable
		...
		function trySetAttr(node, attrName, dataAttr, cachedAttr, cachedAttrs, tag, namespace) {
			if (!(attrName in cachedAttrs) || cachedAttr !== dataAttr || (typeof dataAttr === "undefined" ? "undefined" : _typeof(dataAttr)) === "object" || $document.activeElement === node) {
